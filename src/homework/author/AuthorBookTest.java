...
public class AuthorBookTest {
    ...
    public static void main(String[] args) {
        ...
        bookStorage.add(new Book("AG1123455", "girq1", "nor", 5000, 10, new
                Author("poxos", "poxosyan", 22, "poxos@mail.com", "male")));
        bookStorage.add(new Book("AG0123498", "girq2", "nor2", 10000, 5, new
                Author("poxos", "poxosyan", 22, "poxos@mail.com", "male")));
        bookStorage.add(new Book("AG8123807", "girq3", "nor3", 2000, 50, new
